...
class FEMMSimulationController():
    ...
    def load_data(self):
        ...
        if file_name in os.listdir("./"):
            with open("./"+file_name, "r") as file:
                ...
                #TODO: eu deveria atualizar o valor da temperatura aqui?
    ...
    def set_femm_atributes(self, ca, cb, cc, temperatura, index, first, folder_name):
        self.correnteA = ca
    ...
    def iniciar_femm(self):
        ...
        write_log("#Correntes tratadas:")
        write_log(f"-CorrenteA: {self.correnteA}")
        write_log(f"-CorrenteB: {self.correnteB}")
        write_log(f"-CorrenteC: {self.correnteC}")
